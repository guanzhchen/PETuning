...
from transformers.adapters.models.bert import BertModelHeadsMixin, BertModelAdaptersMixin
...
class RobertaPrefixForSequenceClassification(ModelWithHeadsAdaptersMixin, RobertaPreTrainedModel):
    def __init__(self, config):
        super().__init__(config)
        self.num_labels = config.num_labels
        self.config = config
...
class RobertaLoraForSequenceClassification(ModelWithHeadsAdaptersMixin, RobertaPreTrainedModel):
    def __init__(self, config):
        super().__init__(config)
        self.num_labels = config.num_labels
        self.config = config
