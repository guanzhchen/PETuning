...
WIKI_DATASETS = ['wikitext']

TASKS = ["glue", "superglue", "ner", "srl", "qa", "wikitext"]

DATASETS = GLUE_DATASETS + SUPERGLUE_DATASETS + NER_DATASETS + SRL_DATASETS + QA_DATASETS + WIKI_DATASETS
